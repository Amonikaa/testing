...
import com.buildingmarket.Interceptor.LoggingInterceptor;
...
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler(ConstantURL.RESOURCE_HANDLER)
				.addResourceLocations(ConstantURL.RESOURCE_LOCATION);
	...
	public CommonsMultipartResolver getCommonsMultipartResolver() {
		...
		multipartResolver
				.setMaxInMemorySize(IConstant.MULTIPART_MAX_IN_MEMORY_SIZE);
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(new LoggingInterceptor())
				.addPathPatterns("/**").excludePathPatterns("/adminLogin");
	}
