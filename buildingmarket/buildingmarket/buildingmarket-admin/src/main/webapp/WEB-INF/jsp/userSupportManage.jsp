...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Manage User Support</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
									...
									<tbody>
										...
										<c:if test="${not empty oldList}">
											<c:forEach var="oldList" items="${oldList}">
												<tr class="odd gradeX">
													<td>${oldList.contactsupportId}</td>
													<td>${oldList.name}</td>
													<td>${oldList.mobile}</td>
													<td>${oldList.query}</td>
													<td><a
														href="deleteSupport?contactsupportId=${oldList.contactsupportId}"
