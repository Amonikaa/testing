...
public class HibernateConfiguration {
	...
	private Properties hibernateProperties() {
		...
		/*
		 * properties.put(IConstant.HIBERNATE_SHOW_SQL,
		 * environment.getRequiredProperty(IConstant.HIBERNATE_SHOW_SQL));
		 * properties.put(IConstant.HIBERNATE_FORMAT_SQL,
		 * environment.getRequiredProperty(IConstant.HIBERNATE_FORMAT_SQL));
		 */
