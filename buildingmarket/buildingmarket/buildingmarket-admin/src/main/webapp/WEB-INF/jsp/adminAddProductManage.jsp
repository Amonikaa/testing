									...
									<tbody>
										...
										<c:if test="${not empty oldList}">
											<c:forEach var="oldList" items="${oldList}">
												<tr class="odd gradeX">
													<td>${oldList.adminProductId}</td>
													<td>${oldList.adminProductName}</td>
													<td><a
														href="updateAdminProduct?productId=${oldList.adminProductId}"><img
															src="resources/img/user_edit.png" alt="" title=""
															border="0" /></a></td>
													<td><a
														href="deleteAdminProduct?productId=${oldList.adminProductId}"
