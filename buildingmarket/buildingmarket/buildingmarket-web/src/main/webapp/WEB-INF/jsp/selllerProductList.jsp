...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Seller Product List</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
										<c:if test="${empty sellerProductList }">
											<tr class="odd gradeX">
												<td colspan="8">No Seller Product found</td>
											</tr>
										</c:if>
										<c:if test="${not empty sellerProductList}">
											<c:forEach var="oldList" items="${sellerProductList}">
												<tr class="odd gradeX">
													...
													<td><a
														href="updateSellerProductForm?productSkuId=${oldList.productId}"><img
															src="resources/img/user_edit.png" alt="" title=""
															border="0" /></a></td>
													<td><a
														href="deleteSellerProductForm?productSkuId=${oldList.productId}"
