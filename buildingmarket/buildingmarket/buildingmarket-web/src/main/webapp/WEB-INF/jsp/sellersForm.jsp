		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h3 class="section-heading buyer">3 EASY STEPS TO SELLING YOUR
						BUILDING PRODUCTS</h3>
				</div>
			</div>
			<div class="row ">
				<div class="col-sm-4 col-md-4">
					<div class="buyerbox">
						<span> <img src="resources/img/page-tick.png">
						</span>
						<h4 class="service-heading">STEP 1</h4>
						<h6>Enter the products you want to sell including details and
							your best price</h6>
				...
				<div class="col-sm-4 col-md-4">
					<div class="buyerbox">
						<span> <img src="resources/img/piggy-bank.png">
						</span>
						<h4 class="service-heading">STEP 2</h4>
						<h6>Buyers confirm purchase order, you receive payment</h6>
						<p class="text-muted">Quam adita delique consero bea
							velluptatis eossequis aspereh endame cuptate</p>
					</div>
				</div>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="resources/img/portfolio/startup-framework-preview.png"
									alt="">
								<p>
