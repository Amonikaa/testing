...
<body id="page-top" class="index">
		...
		<div class="container">
			<div class="intro-text">
				...
				<div class="col-sm-6 col-md-6 col-lg-6">
					<div class="intro-lead-in">THE NEW WAY TO BUY BUILDING
						PRODUCTS</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h3 class="section-heading buyer">3 EASY STEPS TO BUY BUILDING
						PRODUCTS AND ARRANGE DELIVERY WITHIN MINUTES</h3>
				</div>
			</div>
			<div class="row ">
				<div class="col-sm-4 col-md-4">
					<div class="buyerbox">
						<span> <img src="resources/img/computer.png">
						</span>
						<h4 class="service-heading">STEP 1</h4>
						<h6>Buy products at live prices, or make a bid</h6>
						<p class="text-muted">Quam adita delique consero bea
							velluptatis eossequis aspereh endame cuptate</p>
					</div>
				</div>
				<div class="col-sm-4 col-md-4">
					<div class="buyerbox">
						<span> <img src="resources/img/cards.png">
						</span>
						<h4 class="service-heading">STEP 2</h4>
						<h6>Easy payment system for settlement</h6>
						<p class="text-muted">Quam adita delique consero bea
							velluptatis eossequis aspereh endame cuptate</p>
					</div>
				</div>
				<div class="col-sm-4 col-md-4">
					<div class="buyerbox">
						<span> <img src="resources/img/transport.png">
						</span>
						<h4 class="service-heading">STEP 3</h4>
						<h6>Products are delivered when you want</h6>
						<p class="text-muted">Quam adita delique consero bea
							velluptatis eossequis aspereh endame cuptate</p>
					</div>
				</div>
	...
	<section class="buy">
		<div class=" col-lg-5 buyerbox_1">
			HOW OUR TRADING PLATFORM WORKS <span>FOR BUYERS</span>
			<p class="buyer_txtnml">Ovitia cores ea quidese quaerumque et
				odicide volupti occuptam aut ex eosa quuntes ad maiossi tatius dolum
				velis et que poribus ditatur modis.</p>
			<p class="buyer_txt">Ovitia cores ea quidese quaerumque et
				odicide volupti occuptam aut ex eosa quuntes ad maiossi tatius dolum
				velis et que poribus ditatur modis.</p>
			<p class="buyer_txt">Incto qui omnihil lignat quisin poreror
				itatecatio et accaepu damus, officimi, veliquo dis nitio. Ut aut
		...
		<div class="col-lg-7 buyerbox_2">
			<div class="col-lg-12 marbtm">
				<img src="resources/img/buyer-img-1.png">
			</div>

			<div class="col-lg-12">
				<img src="resources/img/buyer-img-2.png">
			</div>
		</div>
	</section>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="resources/img/portfolio/startup-framework-preview.png" alt="">
								<p>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="resources/img/portfolio/escape-preview.png" alt="">
								<p>
